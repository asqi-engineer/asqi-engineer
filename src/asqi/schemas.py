...
class OutputReports(BaseModel):
    ...
    name: str = Field(
        ...,
        description="The technical report name, e.g., 'detailed_report', 'summary_report'.",
    )
    type: Literal["pdf", "html"] = Field(
        ..., description="The report type name, only 'pdf' or 'html'."
    )
    description: Optional[str] = Field(
        None, description="Short description of the report's content."
    )
...
class Manifest(BaseModel):
    ...
    output_reports: List[OutputReports] = Field(
        ...
        description="Defines reports generated by the test container.",
    )
...
class ScoreCardIndicator(BaseModel):
    ...
    display_reports: List[str] = Field(
        default_factory=list,
        description=(
            "List of technical report names to include from the test container manifest."
        ),
    )
