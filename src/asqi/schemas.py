...
class DatasetFeature(BaseModel):
    ...
    # TODO: add type: hf dataset types
    description: Optional[str] = Field(
...
class InputDataset(BaseModel):
    ...
    type: List[Literal["huggingface", "pdf", "txt"]] = Field(
        ...,
    ...
    features: Optional[list[DatasetFeature]] = Field(
        [],
        description="List of required features within the dataset (required for HuggingFace dataset type). Required feature names can be mapped to a different feature name in the dataset. The default without a mapping is to require the same feature name.",
    )
